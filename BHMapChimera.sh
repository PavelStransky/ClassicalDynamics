...
#SBATCH --array=0-8100%500             # one task per block of PAIRS_PER_TASK pairs: cld(101*301, 100) = 305 tasks (BHMapChimera.jl prints the exact range)
