...
SolveEnergy(energy, parameters, 500, savePath=savePath, timeout=20000, showFigures=true, randomize=true, tolerance=1e-8, sectionCoordinateX=1, sectionCoordinateY=3, sectionPlane=2)
